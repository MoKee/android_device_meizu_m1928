...
Return<void> FingerprintInscreen::onPress() {
    ...
    this->mGoodixFpDaemon->sendCommand(NOTIFY_FINGER_DOWN, nullptr);
    return Void();
}

Return<void> FingerprintInscreen::onRelease() {
    set(HBM_ENABLE_PATH, 0);
    this->mGoodixFpDaemon->sendCommand(NOTIFY_FINGER_UP, nullptr);
    return Void();
}

Return<void> FingerprintInscreen::onShowFODView() {
    set(BOOST_ENABLE_PATH, 1);
    this->mGoodixFpDaemon->sendCommand(NOTIFY_UI_READY, nullptr);
    return Void();
}

Return<void> FingerprintInscreen::onHideFODView() {
    this->mGoodixFpDaemon->sendCommand(NOTIFY_UI_DISAPPER, nullptr);
    return Void();
}
